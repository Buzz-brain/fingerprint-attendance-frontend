...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-4 right-4 z-[100] flex flex-col items-end space-y-2 w-full max-w-xs md:max-w-sm",
      className,
    )}
    {...props}
  />
...
const toastVariants = cva(
  [
    ...
    "rounded-xl border border-muted bg-white/90 backdrop-blur-md p-6 pr-8 shadow-2xl transition-all",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn(
      "text-base font-bold tracking-tight text-primary drop-shadow-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn(
      "text-sm text-muted-foreground/90 mt-1 leading-relaxed",
      className
    )}
    {...props}
  />
